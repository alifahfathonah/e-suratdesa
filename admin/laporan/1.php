  ...
  <section class="content">      
    <div class="row">
      <div class="col-md-12">
        <div class="col-md-11">
          <?php
            if(isset($_GET['filter']) && ! empty($_GET['filter'])){
              $filter = $_GET['filter'];
              if($filter == '1'){
                echo '<a name="cetak" target="output" class="btn btn-primary btn-md" href="print1.php"><i class="fas fa-print"></i> Cetak Laporan</a>';
              }else if($filter == '2'){
                $tgl = date('d-m-y', strtotime($_GET['tanggal']));
                echo '<a name="cetak" target="output" class="btn btn-primary btn-md" href="print1.php?filter=2&tanggal='.$_GET['tanggal'].'"><i class="fas fa-print"></i> Cetak Laporan</a>';
              }else if($filter == '3'){
                $nama_bulan = array('', 'Januari','Februari','Maret','April','Mei','Juni','Juli','Agustus','September','Oktober','November','Desember');
                echo '<a name="cetak" target="output" class="btn btn-primary btn-md" href="print1.php?filter=3&bulan='.$_GET['bulan'].'&tahun='.$_GET['tahun'].'"><i class="fas fa-print"></i> Cetak Laporan</a>';
              }else if($filter == '4'){
                echo '<a name="cetak" target="output" class="btn btn-primary btn-md" href="print1.php?filter=4&tahun='.$_GET['tahun'].'"><i class="fas fa-print"></i> Cetak Laporan</a>';
              }
            }else{
              echo '<a name="cetak" target="output" class="btn btn-primary btn-md" href="print1.php"><i class="fas fa-print"></i> Cetak Laporan</a>';
            }
        ...
        <div class="col-md-1">
          <a name="filter" target="output" class="btn btn-md" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-filter"></i> Filter</a>
        </div><br>
            ...
            <div class="modal-content">
              ...
              <form method="get" action="">
                ...
                <div class="modal-footer">
                  <button type="button" class="btn btn-secondary" onclick="window.location.href='1.php'">Reset Filter</button>
